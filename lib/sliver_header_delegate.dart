...
import 'package:sliver_delegate/src/extension/widget_extension.dart';
import 'package:sliver_delegate/src/item/header_background.dart';
        ...
        children: [
          ...
          Positioned(
            ...
            child: AppBar(
              ...
              actions: actions,
              leading: (leadingShow == true) ? leading : const SizedBox(),
              title: title,
              elevation: 0,
            ),
          ),
